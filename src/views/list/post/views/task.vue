...
import { getListPostTree, getPostTask } from '@/api/modules/list';
...
<template>
  <el-tab-pane class="h-full flex">
    ...
    <div class="flex-1 flex flex-col pt-2.5">
      <pro-table :columns="columns" :request-api="getPostTask" ref="tableRef" row-key="deptId">
